    ...
    <div className="home">
      <main className="content">
       ...
       <div className="description">
          <p>Op <span className="highlight">vrijdag 13 maart 2026</span> 
          organiseert de Erasmus Hogeschool Brussel een inspirerende Career Launch Day
           voor alle studenten van de opleidingen Design & Technologie. 
          ...
          <p>Of je nu op zoek bent naar een stage, een eerste job, of gewoon inspiratie
             wilt opdoen voor je toekomst: de Career Launch Day is dé plek om je carrière een vliegende start te geven!</p>
        </div>
        ...
        <div className="faq-section">
          ...
          <div className="faq-item">
            ...
            <p>De Career Launch Day is dé kans om bedrijven te ontmoeten, 
              je netwerk uit te breiden, en alles te weten te komen over stage- en jobmogelijkheden binnen jouw vakgebied.</p>
          </div>
          
          <div className="faq-item">
            <div className="faq-question">Hoe?</div>
            <p>Schrijf je vooraf in via het inschrijvingsformulier. 
              Op de dag zelf ontvang je een programma met alle workshops, infosessies en bedrijven die aanwezig zijn.</p>
          </div>
        </div>
